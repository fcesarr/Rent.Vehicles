...
public abstract class ConsumerCreateCommandPublisherBackgroundService<TCommand, TEvent, TEntity> : HandlerConsumerCommandToEntityPublisherBackgroundService<TCommand, TEvent, TEntity>
    ...
    where TEntity : Entities.Command
{
    ...
    protected ConsumerCreateCommandPublisherBackgroundService(ILogger<ConsumerCreateCommandPublisherBackgroundService<TCommand, TEvent, TEntity>> logger,
        IModel channel,
