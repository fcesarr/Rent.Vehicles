...
public abstract class HandlerConsumerCommandToEntityBackgroundService<TCommand, TEvent, TEntity> : BackgroundService 
    where TCommand : Messages.Command
    where TEvent : Messages.Event
    where TEntity : Entities.Command
{
    protected readonly ILogger<HandlerConsumerCommandToEntityBackgroundService<TCommand, TEvent, TEntity>> _logger;
    ...
    public HandlerConsumerCommandToEntityBackgroundService(ILogger<HandlerConsumerCommandToEntityBackgroundService<TCommand, TEvent, TEntity>> logger,
        IModel channel,
